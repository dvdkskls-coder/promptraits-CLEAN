...
export const PHOTO_STYLES_DATA = {
  ...
  "D. Beauty, Makeup, or Fashion Styles": [
    {
      id: "glamour_portrait",
  ...
  "F. Modern Perspectives & Aesthetics": [
    {
  ...
  "G. Photographic Technique Portraits": [
    ...
    },
    {
      ...
      name: "Analog / Film Look Portrait",
      description: "Grain, organic color, characteristic imperfections.",
    },
  ],
  "H. Subject or Context Portraits": [
    {
      id: "professional_headshot",
      name: "Professional / Actor Headshot",
      description:
  ...
  "I. AI & Prompt Engineering Styles": [
    {
    ...
    },
    {
      ...
      name: "Photographic RAW Portrait",

...
// REVISIÓN: Aplanado a un solo array para compatibilidad con el componente
...
export const SHOT_TYPES = [
  ...
  },
  {
    id: "two_shot",
    name: "Two-Shot",
    description: "Two characters sharing the frame with compositional balance.",
  },
  {
    id: "three_shot",
    name: "Three-Shot",
  ...
  // G. Macro & Proximity Shots
  {
    id: "macro_close_up",
    name: "Macro Close-Up",
    description: "An extreme close-up of a small object, full of fine detail.",
  },
  {
    id: "macro_1_1",
    name: "1:1 Macro (Life-Size)",
    description: "The subject's size on the sensor equals its real-life size.",
  },
  {
    id: "extreme_macro",
...
export const getShotTypeById = (id) => {
  // Arreglado: ahora busca en el array 'SHOT_TYPES'
...
export default {
  SHOT_TYPES, // Arreglado: ahora exporta el array 'SHOT_TYPES'
  getShotTypeById,
};

...
export default function AIGenerator() {
  ...
  const examples = [
    { label: 'Fantasía épica', value: 'Un dragón majestuoso volando sobre montañas nevadas al atardecer' },
    { label: 'Cyberpunk', value: 'Una calle futurista con neones y hologramas en una noche lluviosa' },
    { label: 'Naturaleza', value: 'Un bosque mágico con luciérnagas y árboles bioluminiscentes' }
  ];
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-8 mb-8">
          <div className="space-y-6">
            ...
            <button
              ...
              disabled={loading || !theme.trim() || !user || (profile && profile.credits < 1)}
